...
describe("Navbar Component", () => {
  ...
  it("should call setLocaleAction and refresh when changing language on desktop", async () => {
    render(<Navbar brand="TestBrand" links={links} dict={dict} currentLang="id" />);
  ...
  it("toggles mobile menu, handles language switch, and closes on mobile link click", async () => {
    render(<Navbar brand="TestBrand" links={links} dict={dict} currentLang="id" />);
