        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          {data.posts.map((post, idx) => (
            <ScrollReveal
              ...
              className="h-full"
            >
              <div className="h-full flex flex-col md:flex-row bg-white/90 dark:bg-zinc-900/50 backdrop-blur-sm border border-zinc-200/60 dark:border-zinc-800/40 shadow-sm hover:shadow-2xl hover:shadow-cyan-500/5 hover:-translate-y-2 transition-all duration-500 rounded-2xl overflow-hidden group">
                {/* Image Section */}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-zinc-500 dark:text-zinc-400 font-medium">
                      <span className="flex items-center">
                        <i className="far fa-user mr-1 text-cyan-500 dark:text-cyan-400" />
                        {post.author}
                      </span>
                      ...
                      <span className="flex items-center">
                        <i className="far fa-calendar-alt mr-1 text-cyan-500 dark:text-cyan-400" />
                        {post.date}
                      </span>
                    </div>
